...
const SigninPage = () => {
  ...
  const handleSignIn = () => {
    if(email == "" || password == "") {
      ...
      console.log("email: " + email + ", password: " + password + ", isRemember: " + isRemember);
               ...
               {SIGNIN_CONSTANTS.SIGN_IN_MESSAGE}
                ...
                <div>
                  ...
                  <div className="mb-8 flex flex-col justify-between sm:flex-row sm:items-center">
                    ...
                    <div>
                      <Link
                        href={ROUTE_CONSTANTS.FORGOT_PASSOWRD}
                ...
                <p className="text-center text-base font-medium  text-body-color">
                  ...
                  <Link href={ROUTE_CONSTANTS.SIGN_UP} className="ml-1 text-primary hover:underline">
